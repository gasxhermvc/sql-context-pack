...
**Specification version:** `1.25`
**Current product version:** `1.3.0`; complete-capture, indexed-context, and safe routine deployment release
...
7. `docs/usage-examples.md` contains exactly three progressive end-to-end examples named ง่าย,
   กลาง, and พลิกแพลง. They cover bounded masked Markdown Query Data, exact named-object context
